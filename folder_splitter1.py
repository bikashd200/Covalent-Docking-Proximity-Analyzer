...
def move_files(abs_dirname):
    ...
    No_of_files = len(os.listdir(abs_dirname))

    print("Total number of files : " + str(No_of_files))

    N = math.ceil(No_of_files/No_of_folders) # the number of files in each subfolder
